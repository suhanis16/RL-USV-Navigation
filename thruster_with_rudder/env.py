...
class Environment(gym.Env):
    def __init__(self, start_pos: tuple = (100, 100), end_pos: tuple = (1000, 700), max_steps: int = 1500):
    ...
    def step(self, action, dt=1/60):
        ...
        # observation = (self.agent.rect.x, self.agent.rect.y, self.agent.angle, self.agent.velocity, self.flow_field.get_flow_direction(self.agent.rect.x, self.agent.rect.y), dist_to_goal)
        observation = (self.agent.rect.x, self.agent.rect.y, self.agent.angle, self.agent.velocity, dist_to_goal)
